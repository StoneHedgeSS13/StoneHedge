...
/datum/job/roguetown/artificer
	title = "Dwarven Artificer"
	flag = ARTIFICER
	department_flag = FORGE
	faction = "Station"
	total_positions = 10
	spawn_positions = 10
	...
	spells = list(/obj/effect/proc_holder/spell/invoked/mending5e, /obj/effect/proc_holder/spell/self/forgedwarf_shout, /obj/effect/proc_holder/spell/self/forgedwarf_ignite)
