/datum/job/roguetown/wytcher
	...
	tutorial = "As a Wytcher, you have been tasked with hunting the various monsters that haunt the dream dales. Using Magick; Divine Powers and your Arsenal of Tools; you are the stuff of legends which must fight the forces of darkness and deceipt."
	whitelist_req = FALSE

	outfit = /datum/outfit/job/roguetown/wytcher
	display_order = JDO_WYTCHER
	give_bank_account = 36
	min_pq = 10
	max_pq = null

/datum/outfit/job/roguetown/wytcher/pre_equip(mob/living/carbon/human/H)
	..()
