/datum/job/roguetown/gravesinger
	...
	outfit = /datum/outfit/job/roguetown/gravesinger
	display_order = JDO_GRAVESINGER
	give_bank_account = TRUE
	min_pq = 5
	max_pq = null

/datum/outfit/job/roguetown/gravesinger
	allowed_patrons = list(/datum/patron/divine/yamais)

/datum/outfit/job/roguetown/gravesinger/pre_equip(mob/living/carbon/human/H)//Updated to have medium armor, because they'll be at odds with Necromancers and likely be targeted by antags.
	..()
