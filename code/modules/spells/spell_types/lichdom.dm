...
/obj/effect/proc_holder/spell/targeted/lichdom/cast(list/targets,mob/user = usr)
	for(var/mob/M in targets)
		...
		if(ishuman(M))
			...
			H.dropItemToGround(H.wear_shirt)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/roguetown/shirt/robe/necromancer(H), SLOT_ARMOR)
			H.equip_to_slot_or_del(new /obj/item/clothing/suit/roguetown/shirt/undershirt/puritan(H), SLOT_SHIRT)
