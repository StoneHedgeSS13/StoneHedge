...
/obj/structure/fluff/statue/sune
	name = "statue of Viriitri"
	desc = "Viriitri, goddess of love, beauty, passion, and pleasure. She teaches that beauty is sacred, love is transformative, and desire is a force to be celebrated rather than denied."
...
/obj/structure/fluff/statue/selune
	name = "statue of Lune"
	desc = "Lune, the Moonmaiden, goddess of the moon, stars, tides, and travelers by night. A gentle yet ancient power, she is the eternal foe of Levishth and a beacon of hope, change, and protection for those who walk in darkness."
